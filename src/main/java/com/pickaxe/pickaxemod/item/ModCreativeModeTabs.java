...
public class ModCreativeModeTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, PickaxeMod.MODID);

    public static final Supplier<CreativeModeTab> PICKAXE_TAB = CREATIVE_MODE_TABS.register(
            "pickaxe_tab",
